...
from quantize.quantizer2 import UniformAffineQuantizer_inmportance
...
class QuantMatMul(nn.Module):
    def __init__(
        ...
        self.x2_quantizer = UniformAffineQuantizer_inmportance(**x2_quant_params)
        self.matmul_func = matmul_func

        self.disable_act_quant = disable_act_quant

    def set_ic_cluster_counts(
    ...
    def quant_x2(self, x2, input):
        if self.use_act_quant:
            x2 = self.x2_quantizer(x2, input)
        return x2
